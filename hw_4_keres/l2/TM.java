...
public class TM
{
    ...
    public boolean transition(char symbol){
        ...
        else if (state.equals("Q1") && (symbol == '1')){
            state = "Q2";write_symbol('*'); move_left(); return true;
        }
        else if (state.equals("Q1") && (symbol == '%')){
            state = "Q9"; move_left(); return true;
        }
        else if (state.equals("Q2") && (symbol == '0' || symbol=='1')){
            state = "Q2"; move_left(); return true;
        }
        else if (state.equals("Q2") && (symbol == '%')){
            state = "Q3"; move_right(); return true;
        }
        else if (state.equals("Q3") && (symbol == '*' || symbol=='1')){
            state = "Q3"; move_right(); return true;
        }
        else if (state.equals("Q3") && (symbol == '0')){
            state = "Q4";write_symbol('*'); move_right(); return true;
        }
        else if (state.equals("Q4") && (symbol == '*' || symbol=='1')){
            state = "Q4"; move_right(); return true;
        }
        else if (state.equals("Q4") && (symbol == '0')){
            state = "Q5";write_symbol('*'); move_left(); return true;
        }
        else if (state.equals("Q5") && (symbol == '0' || symbol=='1'||symbol=='*')){
            state = "Q5"; move_left(); return true;
        }
        else if (state.equals("Q5") && (symbol == '%')){
            state = "Q6"; move_right(); return true;
        }
        else if (state.equals("Q6") && (symbol == '0'||symbol=='*')){
            state = "Q6"; move_right(); return true;
        }
        else if (state.equals("Q6") && (symbol == '1')){
            state = "Q7";write_symbol('*'); move_left(); return true;
        }
        else if (state.equals("Q6") && (symbol == '%')){
            state = "Q9"; move_left(); return true;
        }
        else if (state.equals("Q7") && (symbol == '0')){
            state = "Q6";write_symbol('*'); move_right(); return true;
        }
        ...
        else if (state.equals("Q8") && (symbol == '*'||symbol=='1')){
            state = "Q8"; move_right(); return true;
        }
        else if (state.equals("Q8") && (symbol == '0')){
            state = "Q5";write_symbol('*'); move_right(); return true;
        }
